      ...
      <div className="max-w-md mx-auto px-3 h-12 flex items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          <button className="relative p-1.5 hover:bg-[#0a0e1a] rounded-full transition">
            ...
            <span className="absolute top-0.5 right-0.5 w-1.5 h-1.5 bg-[#ff4d5a] rounded-full" />
          </button>

          <div className="relative" ref={dropdownRef}>
            <button
              onClick={() => setDropdownOpen(!dropdownOpen)}
              className="w-6 h-6 rounded-full bg-gradient-to-br from-[#00c2ff] to-[#00d26a] flex items-center justify-center text-[#05070d] font-bold text-[10px]"
            >
              T
            </button>
            ...
            {dropdownOpen && (
              <div className="absolute right-0 top-8 w-56 bg-[#0a0e1a] border border-[#162035] rounded-xl shadow-2xl overflow-hidden">
                <div className="p-3 border-b border-[#162035]">
                  ...
                  <span className="text-[10px] text-gray-400 bg-[#00c2ff]/10 px-2 py-0.5 rounded-full">Akun Gratis</span>
                </div>
                ...
                <div className="border-t border-[#162035] py-1">
                  <button className="w-full px-3 py-2 text-left text-xs hover:bg-[#162035] flex items-center gap-2 text-[#ff4d5a]">
